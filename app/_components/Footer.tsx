...
export const Footer = () => {
  return (
    <div
      className="relative mt-16 text-gray-600"
    ...
    >
      ...
      <div className="px-4 pt-12 ">
        <div className="flex flex-col items-end justify-between w-full xl:flex-row gap-2">
          <div>
            ...
            <p className="text-sm text-deep-purple-50 py-2">
          ...
          <div className="flex items-center justify-end gap-20 px-10 w-full my-2">
            <div>
